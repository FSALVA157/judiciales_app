...
export class InternosService {
  ...
  crearInterno(data: any){
    ...
    provincia_id: parseInt(data.provincia_id),
    ...
    jurisdiccion1_id: parseInt(data.jurisdiccion1_id),
    jurisdiccion2_id: parseInt(data.jurisdiccion2_id),
    ...
    jurisdiccion_provincia_id: parseInt(data.jurisdiccion_provincia_id),
  ...
  getInternoXId(id_interno: number){
    ...
    return this.http.get<InternoModel>(`${environment.BASE_URL}/interno/${id_interno}`);
  }
